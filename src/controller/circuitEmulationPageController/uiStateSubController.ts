...
export interface UiStateSubControllerDeps {
  setUiState: <K extends keyof CircuitEmulationPageUiStateModel>(
    key: K,
    value: CircuitEmulationPageUiStateModel[K],
  ) => void;
}

export const useUiStateSubController = ({ setUiState }: UiStateSubControllerDeps) => {
